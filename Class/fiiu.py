...
class FIIU:
    ...
    def refined_plot_flights_from_country(self, country, internal=False, short_haul_cutoff=1000):
            ...
            potential CO2 emissions reduction by replacing flights with trains, the total number of short-haul flights,
            ...
            the total number of short-haul flights, and visualizes the flight paths on a world map.
            """
            ...
            short_haul_flights_count = 0   # Initialize count for short-haul flights

            # Define emissions factors (source: https://ourworldindata.org/travel-carbon-footprint)
            ...
            for _, row in relevant_routes.iterrows():
                ...
                if is_short_haul:
                    ...
                    short_haul_flights_count += 1  # Increment the short-haul flight count
            ...
            # Annotations for total short-haul distance, total short-haul flights, and potential emission reductions
            annotations = [
                go.layout.Annotation(
                    text=f"Total short-haul flights: {short_haul_flights_count}, Total short-haul distance: {total_short_haul_distance:.2f} km",
                    align='left',
                    showarrow=False,
                    xref='paper',
                    yref='paper',
