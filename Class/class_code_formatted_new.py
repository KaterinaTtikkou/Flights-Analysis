...
class FIIU:
    ...
    def plot_flights_from_country(self, country, internal=False):
        ...
        and the title of the plot indicates whether it shows internal flights or
        all flights from the country.
        """
    ...
    def aircrafts(self):
        """
        Retrieve a list of unique aircraft names 
        based on the merged data of routes and airplanes.
    ...
    def aircraft_info(self, _aircraft_name):
        ...
        Raises:
        - ValueError: 
        If the provided aircraft name is not found in the dataset.
        Instructs the user to choose a valid aircraft name from the available dataset.
        - ValueError: 
        If the OpenAI API key is not found in the environment variable.
        ...
        if _aircraft_name not in self.aircrafts_data:
            raise ValueError(
                f"Aircraft {_aircraft_name} not found. Please choose a valid aircraft name from the dataset. "
